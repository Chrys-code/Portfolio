...
const SkillList = [{
    Title: "Technologies", SubTitle: "Technologies I use daily", description: "HTML, CSS, JavaScript, React, Next, SASS, Node, Express, MongoDB", year: "",
}, {
    Title: "Technologies", SubTitle: "Technologies I am familiar with", description: "Redux, PHP, MySQL, Firebase, Apollo, GraphQL", year: "",
}, {
    ...
    Title: "Design concepts", SubTitle: "Architectural Design", description: "Monolithic & Microservices Architectural Design, Model-View-Controller & ViewModel Pattern, Observer/pub-sub pattern", year: "",
}, {
    Title: "Methodologies", SubTitle: "Methodologies to deliver software", description: "Software Development Life Cycle (SDLC), Test-driven development, Design Thinking, Design Sprint, Agile development, Waterfall development", year: "",
}, {
    Title: "Digital Design", SubTitle: "Technologies I use regularly to achieve contemporary design", description: "AdobeXD and Figma", year: "",
}, {
    Title: "What I learn right now", SubTitle: "Web technologies I currently learn & practice", description: "Currently learning Unit, Integration and E2E testing with Jest & React-testing library", year: "",
},
]
...
const WorkList = [
    ...
    },
    {
        ...
        Title: "Drag&Drop List", SubTitle: "MVC Trello-Clone", description: " I am practicing the base stack of web development (HTML5-CSS3-JavaScript) constantly. Trello-Clone is the first step to deepen my knowledge within the stack to achieve an advanced level of programming resulting in clear, maintinable, scalable, and performant applications. The project implements Model-View-controller Pattern in Vanilla JavaScript.", year: "11-2020"
    },
]
